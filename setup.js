window.onload = function() {
  ...
  document.body.innerHTML = "<div id='header'><div id='header-inner'><div class='logo'><div class='logo-tag'>&lt/></div><div class='logo-text'>Brandon</div></div><div id='header-right'>US National Parks</div></div></div><div id='content'>" + document.body.innerHTML + "</div>";
};
